...
class ParseArgsCatTest < Minitest::Test
  ...
  def test_case_in_matched
    ...
    case body
    in Kanayago::FunctionCallNode(mid: :foo, args: Kanayago::ArgsCatNode)
      assert(true)
    end
  end
  ...
  def test_single_in
    ...
    body in Kanayago::FunctionCallNode(mid: :foo, args: Kanayago::ArgsCatNode)
  ...
  def test_right_assignment
    ...
    body => Kanayago::FunctionCallNode(mid: :foo, args: Kanayago::ArgsCatNode)
